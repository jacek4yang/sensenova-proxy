...
pub struct ClassifiedUpstreamError {
    ...
    /// opposed to a per-key transient rate limit. The router routes on the
    /// *class*; this flag remains for observability and for callers that need
    /// to distinguish explicit quota wording from a generic 429.
